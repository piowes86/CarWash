...
class CarList {
    ...
    init() {
        ...
        carList.append(Car(plate: "AA SF 4894", brand: "Mercedes", model: "CLS", type: .sedan, cleaned: true, adoptionDate: "29.10.2017", washingDate: "", completionTimeLimit: "2.11.2017"))
        ...
        carList.append(Car(plate: "RW KL 8848", brand: "BMW", model: "M5", type: .sedan, cleaned: true, adoptionDate: "30.10.2017", washingDate: "", completionTimeLimit: "10.11.2017"))
        ...
        carList.append(Car(plate: "WT TN 1981", brand: "Audi", model: "A7", type: .sedan, cleaned: true, adoptionDate: "20.10.2017", washingDate: "", completionTimeLimit: "5.11.2017"))
        ...
        carList.append(Car(plate: "KA AG 9844", brand: "Mercedes", model: "C", type: .sedan, cleaned: true, adoptionDate: "31.10.2017", washingDate: "", completionTimeLimit: "10.11.2017"))
